...
<div class="modal-header" style="background-color: #343a40;">
    ...
    <h4 class="modal-title" style="color: white;">Panel para reservar un ip para un ap</h4>
</div>
                ...
                <form method="POST" role="form" id="form6">
                    <div class="form-group col-sm-12">
                        ...
                        <select name="ap" id="ap" class="form-control">
                            <option value="">Seleccione la ap a la que le asignara la ip</option>
                            <?php
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    <input type="hidden" name="process" id="process" value="reservar">
...
<script>
    ...
    function reservar_ip() {
        ...
        Swal.fire({
            title: "Reservando una ip para un equipo",
            text: "Espera un momento",
            type: "info",
            showLoaderOnConfirm: true,
            onOpen: function() {
